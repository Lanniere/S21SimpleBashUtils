...
#include "../container/list/s21_list.h"
...
//   auto pos = l.begin();
//   ++pos; ++pos; ++pos;
//   auto it = l.insert_many(pos, 10, 20);
//   l.print();
...
TEST(ListTest, InsertManyEmptyList) {
  s21::list<int> l;
  auto it = l.insert_many(l.cbegin(), 5, 10, 15);
  s21::list<int> expected{5, 10, 15};

  EXPECT_TRUE(l == expected);
  EXPECT_EQ(*it, 5);
}

TEST(ListTest, InsertManyAtBeginning) {
  s21::list<int> l{1, 2, 3};
  auto it = l.insert_many(l.cbegin(), -1, 0);
  s21::list<int> expected{-1, 0, 1, 2, 3};
...
TEST(ListTest, InsertManyAtEnd) {
  s21::list<int> l{1, 2, 3};
  auto it = l.insert_many(l.cend(), 4, 5, 6);
...
TEST(ListTest, InsertManyInMiddle) {
  ...
  ++pos;
  auto it = l.insert_many(pos, 10, 20);
  s21::list<int> expected{1, 2, 10, 20, 3, 4, 5};

  EXPECT_TRUE(l == expected);
  EXPECT_EQ(*it, 10);
}

TEST(ListTest, InsertManyNoElements) {
  s21::list<int> l{1, 2, 3};
  auto pos = l.begin();
  auto it = l.insert_many(l.cbegin());
  s21::list<int> expected{1, 2, 3};
...
TEST(ListTest, InsertManySingleElement) {
  s21::list<int> l{10, 20, 30};
  auto pos = l.begin();
  ++pos;
  auto it = l.insert_many(pos, 15);
  s21::list<int> expected{10, 15, 20, 30};
...
TEST(ListTest, InsertManyStrings) {
  s21::list<std::string> l{"a", "c", "d"};
  auto pos = l.begin();
  ++pos;
  auto it = l.insert_many(pos, std::string("b"), std::string("b2"));
  s21::list<std::string> expected{"a", "b", "b2", "c", "d"};
...
TEST(ListTest, InsertManyBackEmptyList) {
  s21::list<int> l;
  l.insert_many_back(5, 10, 15);
  s21::list<int> expected{5, 10, 15};
  EXPECT_TRUE(l == expected);
}

TEST(ListTest, InsertManyBackNonEmptyList) {
  s21::list<int> l{1, 2, 3};
...
TEST(ListTest, InsertManyBackNoElements) {
  s21::list<int> l{1, 2, 3};
  l.insert_many_back();
  s21::list<int> expected{1, 2, 3};
  EXPECT_TRUE(l == expected);
...
TEST(ListTest, InsertManyBackSingleElement) {
  s21::list<int> l{10, 20, 30};
  l.insert_many_back(15);
  s21::list<int> expected{10, 20, 30, 15};
  EXPECT_TRUE(l == expected);
}

TEST(ListTest, InsertManyBackStrings) {
  s21::list<std::string> l{"a", "c", "d"};
  l.insert_many_back(std::string("b"), std::string("b2"));
  s21::list<std::string> expected{"a", "c", "d", "b", "b2"};
  EXPECT_TRUE(l == expected);
}

TEST(ListTest, InsertManyFrontEmptyList) {
  s21::list<int> l;
  l.insert_many_front(5, 10, 15);
  s21::list<int> expected{5, 10, 15};
  EXPECT_TRUE(l == expected);
}

TEST(ListTest, InsertManyFrontNonEmptyList) {
  s21::list<int> l{1, 2, 3};
...
TEST(ListTest, InsertManyFrontNoElements) {
  s21::list<int> l{1, 2, 3};
  l.insert_many_front();
  s21::list<int> expected{1, 2, 3};
  EXPECT_TRUE(l == expected);
...
TEST(ListTest, InsertManyFrontSingleElement) {
  s21::list<int> l{10, 20, 30};
  l.insert_many_front(15);
  s21::list<int> expected{15, 10, 20, 30};
  EXPECT_TRUE(l == expected);
}

TEST(ListTest, InsertManyFrontStrings) {
  s21::list<std::string> l{"a", "c", "d"};
  l.insert_many_front(std::string("b"), std::string("b2"));
  s21::list<std::string> expected{"b", "b2", "a", "c", "d"};
  EXPECT_TRUE(l == expected);
}